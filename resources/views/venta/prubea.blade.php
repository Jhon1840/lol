    ...
    @section('content')
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#modalConfirmacionCerrarCaja').find('input[type="number"]').on('input',
                    calcularTotalBilletesMonedas);
            ...
            $('#confirmarCerrarCaja').on('click', function() {
                ...
                if (cajaId) {
                    ...
                    console.error('No hay una caja abierta actualmente.');
                }
            });
            ...
            $(document).ready(function() {
                $('.clickable-card').click(function(event) {
                    ...
                    if (!cajaAbierta) {
                        // Mostrar el modal para abrir la caja primero
                        $('#modalAbrirCajaPrimero').modal('show');
                    } else {
                        // Agregar el producto al carrito si hay una caja abierta
